...
@section('body')
    ...
    <div class="kt-portlet">
        ...
        <form class="kt-form kt-form--label-right" method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
            {!! csrf_field() !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group @if($errors->has('short_desc')) validated @endif">
                                    ...
                                    <input type="text" name="short_desc" id="short_desc" class="form-control @if($errors->has('short_desc')) is-invalid @endif" placeholder="Enter Short Desc" value="{{ old('short_desc') }}">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group @if($errors->has('description')) validated @endif">
                                    ...
                                    <textarea name="description" id="description" cols="24" rows="10" class="form-control @if($errors->has('description')) is-invalid @endif">{!! old('description') !!}</textarea>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group @if($errors->has('price')) validated @endif">
                                    ...
                                    <input type="text" name="price" id="price" class="form-control @if($errors->has('price')) is-invalid @endif" placeholder="Enter Price" value="{{ str_replace(',', '', old('price', '')) }}">
