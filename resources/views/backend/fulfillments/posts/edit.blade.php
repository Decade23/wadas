...
@section('body')
    ...
    <div class="kt-portlet">
        ...
        <form class="kt-form kt-form--label-right" method="POST" action="{{ route('posts.update', $dataDb->id) }}" enctype="multipart/form-data">
            {!! csrf_field() !!}
            {{ method_field('PUT') }}
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group @if($errors->has('product')) validated @endif">
                                    ...
                                    <select name="product" id="product" class="form-control @if($errors->has('product')) is-invalid @endif kt-select2">
                                        <option></option>
                                        @if( isset( $dataDb->product ) )
                                            <option value="{{ $dataDb->product->id }}" selected>{{ $dataDb->product->name. ' ('. $dataDb->product->type. ')' }}</option>
                                        @endif
                                    </select>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group @if($errors->has('name')) validated @endif">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @if($errors->has('name')) is-invalid @endif" placeholder="Enter Title" value="{{ old('name', $dataDb->name) }}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group @if($errors->has('short_content')) validated @endif">
                                    ...
                                    <input type="text" name="short_content" id="short_desc" class="form-control @if($errors->has('short_content')) is-invalid @endif" placeholder="Enter Short Content" value="{{ old('short_content', $dataDb->short_content) }}">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group @if($errors->has('content')) validated @endif">
                                    ...
                                    <textarea name="content" id="content" cols="24" rows="10" class="form-control @if($errors->has('content')) is-invalid @endif">{!! old('content', $dataDb->content) !!}</textarea>
