        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <a href="{{ route('posts.create') }}" class="btn btn-brand btn-icon-sm">
        ...
        $(function () {
            ...
            table = $('#user_table').DataTable({
                ...
                columns: [
                    ...
                    // },
                    {data: 'name', name: 'name'},
                    {data: 'short_content', name: 'short_content', defaultContent: '-', orderable: false},
                   // {data: 'product.name', name: 'product.name', defaultContent: '-',orderable: false},
                    //{data: 'kategori', name: 'categories.name', orderable: false},
