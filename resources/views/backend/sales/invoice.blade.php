...
<head>
    ...
    <link href="{{ asset('themes/eci/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
{{--    <link href="themes/eci/css/style.bundle.css" rel="stylesheet" type="text/css" />--}}
<!--end::Global Theme Styles -->

    <!-- PDF -->
    <link href="{{ asset('themes/eci/css/pages/invoices/invoice-2.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="kt-invoice__container">
            <div class="kt-invoice__brand">
                ...
                <div href="#" class="kt-invoice__logo">
                    <a href="#"><img width="203" height="50" src="{{ asset('eci/logo/eci_logo_no_bg.png') }}"></a>
...
{{--<script src="{{ asset('themes/eci/js/scripts.bundle.js') }}" type="text/javascript"></script>--}}
