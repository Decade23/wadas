@if(Sentinel::inRole('root') || Sentinel::hasAnyAccess(['product.show']))
        ...
        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
            <ul class="kt-menu__subnav">
                ...
                @if(Sentinel::inRole('root') || Sentinel::hasAccess(['product.show']))
                    <li class="kt-menu__item @if(request()->is('console/products*')) {{ 'kt-menu__item--active' }} @endif" aria-haspopup="true" >
