...
@section('body')
    ...
    <div class="kt-portlet">
        ...
        <div class="row">
            <div class="col-lg-12">
                <!--begin::Form-->
                <form class="kt-form kt-form--label-right" method="POST" action="{{ route('user.update', $data->id) }}">
                    {{ method_field('PUT') }}
                    {!! csrf_field() !!}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group @if($errors->has('name')) validated @endif">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @if($errors->has('name')) is-invalid @endif" placeholder="Enter Name" value="{{ old('name',$data->name) }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group @if($errors->has('phone')) validated @endif">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control @if($errors->has('phone')) is-invalid @endif" placeholder="Enter Phone" value="{{ old('phone', $data->phone) }}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group @if($errors->has('email')) validated @endif">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control @if($errors->has('email')) is-invalid @endif" placeholder="Enter Email" value="{{ old('email',$data->email) }}" disabled>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group @if($errors->has('gender')) validated @endif">
                                    ...
                                    <select class="form-control @if($errors->has('gender')) is-invalid @endif kt-select2" id="gender" name="gender">
                                        <option value="" @if(old('gender', $data->gender ) == '' || old('gender', $data->gender ) == 'null' ) selected="selected" @endif></option>
                                        <option value="M" {{ old('gender', $data->gender) == 'M' ? 'selected="selected"' : ''}}>Male</option>
                                        <option value="F" {{ old('gender', $data->gender) == 'F' ? 'selected="selected"' : ''}}>Female</option>
                                    </select>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group @if($errors->has('dob')) validated @endif">
                                    ...
                                    <div class="kt-input-icon kt-input-icon--right">
                                        <input type="text" name="dob" id="dob" class="form-control @if($errors->has('dob')) is-invalid @endif" placeholder="Date Of Birth" value="{{ old('dob', $data->dob) }}" readonly>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group @if($errors->has('recentCompany')) validated @endif">
                                    ...
                                    <input type="text" name="recentCompany" id="recentCompany" class="form-control @if($errors->has('recentCompany')) is-invalid @endif" placeholder="Enter Recent Company" value="{{ old('recentCompany', $data->recent_company) }}">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group @if($errors->has('industry')) validated @endif">
                                    ...
                                    <input type="text" name="industry" id="industry" class="form-control @if($errors->has('industry')) is-invalid @endif" placeholder="Enter Industry" value="{{ old('industry', $data->industry) }}">
