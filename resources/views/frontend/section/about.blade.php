...
{{--                    <img src="frontend/images/services/main-fmobile.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="400" alt="iPad">--}}
            ...
            <div class="row topmargin-sm clearfix">
                ...
                <div class="col-lg-6 bottommargin">
                    ...
                    <div class="heading-block nobottomborder" style="margin-bottom: 15px;">
                        <span class="before-heading">Melakukan Perbaikan</span>
                        <h4>Improvement</h4>
                    </div>
                    <p>Membantu perusahaan melakukan perbaikan pada semua lini.</p>
                </div>

                <div class="col-lg-6 bottommargin">
                    <i class="i-plain color i-large icon-line2-energy inline-block" style="margin-bottom: 15px;"></i>
                    <div class="heading-block nobottomborder" style="margin-bottom: 15px;">
                        <span class="before-heading">Meningkatkan Kompetensi</span>
                        <h4>Enhance Competency</h4>
                    </div>
                    <p>Membantu meningkatkan kompetensi perusahaan termasuk personil didalamnya.</p>
                </div>

                <div class="col-lg-6 bottommargin">
                    <i class="i-plain color i-large icon-line2-equalizer inline-block" style="margin-bottom: 15px;"></i>
                    <div class="heading-block nobottomborder" style="margin-bottom: 15px;">
                        <span class="before-heading">Keberlangsungan Bisnis</span>
                        <h4>Sustainability Business</h4>
                    </div>
                    <p>Membantu perusahaan untuk menemukan cara menjaga keberlangsungan bisnis.</p>
                </div>

                <div class="col-lg-6 bottommargin">
                    <i class="i-plain color i-large icon-line2-heart inline-block" style="margin-bottom: 15px;"></i>
                    <div class="heading-block nobottomborder" style="margin-bottom: 15px;">
                        <span class="before-heading">Meningkatkan Kapasitas</span>
                        <h4>Enhance Capacity</h4>
                    </div>
                    <p>Membantu perusahaan menemukan cara terbaik untuk mengembangkan bisnis.</p>
                </div>
    ...
    <div class="container clearfix">
        ...
        <div class="row bottommargin-sm">
            ...
            <div class="col-lg-4 d-md-none d-lg-block bottommargin center">
                <img src="frontend/images/services/iphone7.png" alt="iphone 2">
            </div>
    ...
    <div class="row clearfix align-items-stretch">
        ...
        <div class="col-lg-6 center col-padding" style="background: url('frontend/images/services/main-bg.jpg') center center no-repeat; background-size: cover;">
        </div>
        ...
        <div class="col-lg-6 center col-padding" style="background-color: #F5F5F5;">
            ...
            <div class="center bottommargin">
                <a href="https://vimeo.com/101373765" data-lightbox="iframe" style="position: relative;">
                    <img src="frontend/images/services/video.jpg" alt="Video">
                    <span class="i-overlay nobg"><img src="frontend/images/icons/video-play.png" alt="Play"></span>
                </a>
            </div>
